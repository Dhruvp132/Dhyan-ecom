...
const dummyProducts = [
  {
    ...
    description:
      "Ultra-soft premium cotton t-shirt with a modern fit. Perfect for casual everyday wear or layering. Features reinforced stitching and pre-shrunk fabric.",
    price: 799,
    mainImage:
  ...
  },
  {
    ...
    description:
      "Classic slim-fit jeans crafted from premium stretch denim. Comfortable 5-pocket design with a modern tapered leg. Perfect blend of style and comfort.",
    price: 1899,
    mainImage:
  ...
  },
  {
    ...
    description:
      "Elegant floral print maxi dress perfect for summer events. Lightweight breathable fabric with a flattering A-line silhouette. Features adjustable straps and side pockets.",
    price: 2299,
    mainImage:
  ...
  },
  {
    ...
    description:
      "Cozy pullover hoodie with fun graphic prints. Made from soft cotton blend fabric. Features kangaroo pocket and adjustable drawstring hood.",
    price: 1099,
    mainImage:
  ...
  },
  {
    ...
    description:
      "Timeless polo shirt in premium pique cotton. Features classic collar with 3-button placket. Perfect for smart-casual occasions.",
    price: 999,
    mainImage:
  ...
  },
  {
    ...
    description:
      "Professional tailored blazer perfect for office wear. Features notched lapels, single-button closure, and functional pockets. Made from premium wool blend.",
    price: 3499,
    mainImage:
  ...
  },
  {
    ...
    description:
      "Durable cargo shorts perfect for active kids. Features multiple pockets and adjustable waist. Made from quick-dry breathable fabric.",
    price: 699,
    mainImage:
  ...
  },
  {
    ...
    description:
      "Crisp formal dress shirt with classic fit. Made from easy-care cotton blend. Features button-down collar and chest pocket.",
    price: 1499,
    mainImage:
  ...
  },
  {
    ...
    description:
      "Elegant genuine leather crossbody bag with adjustable strap. Features multiple compartments and zip closure. Perfect for everyday use.",
    price: 2899,
    mainImage:
  ...
  },
  {
    ...
    description:
      "Lightweight running sneakers with cushioned sole and breathable mesh upper. Perfect for jogging, gym, or casual wear.",
    price: 2499,
    mainImage:
  ...
  },
  {
    name: "Knit Sweater",
    description:
      "Cozy knit sweater perfect for cooler weather. Features crew neck and ribbed trim. Made from soft acrylic blend.",
    price: 1799,
    mainImage:
  ...
  },
  {
    name: "Yoga Leggings",
    description:
      "High-waisted yoga leggings with 4-way stretch. Moisture-wicking fabric with hidden pocket. Perfect for yoga, gym, or casual wear.",
    price: 1299,
    mainImage:
